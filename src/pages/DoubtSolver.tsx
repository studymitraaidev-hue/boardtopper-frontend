...
import {
  Send, ImagePlus, X, Sparkles, BookOpen, FlaskConical, Calculator,
  PenTool, History, ChevronRight, Zap, Crown, Loader2,
} from 'lucide-react';
...
const QUICK_PROMPTS: QuickPrompt[] = [
  {
    ...
    subject: 'mathematics',
    color: 'from-violet-500/20 to-purple-500/20 border-violet-300/30',
  },
  {
    ...
    subject: 'science',
    color: 'from-emerald-500/20 to-teal-500/20 border-emerald-300/30',
  },
  {
  ...
  },
  {
    ...
    subject: 'history',
    color: 'from-rose-500/20 to-pink-500/20 border-rose-300/30',
  },
];
...
function GlassCard({
  ...
  return (
    <div
      onClick={onClick}
      className={cn(
        'relative overflow-hidden rounded-2xl bg-white/60 backdrop-blur-xl border border-white/40 shadow-[0_8px_32px_rgba(0,0,0,0.04)] transition-all duration-500 ease-out',
        hover &&
          'hover:shadow-[0_20px_60px_rgba(0,0,0,0.08)] hover:-translate-y-1 hover:scale-[1.02]',
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-indigo-50/30 to-violet-50/20 relative overflow-hidden">
      <div className="fixed inset-0 pointer-events-none overflow-hidden">
        ...
        <div
          className="absolute -bottom-40 -left-40 w-96 h-96 bg-indigo-200/20 rounded-full blur-3xl animate-pulse"
        ...
        <div className="max-w-3xl mx-auto px-4 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="p-2.5 rounded-xl hover:bg-slate-100/80 transition-all duration-300 group"
            >
          ...
          <div className="space-y-8 animate-fade-in">
            <div className="text-center pt-12 pb-4">
              ...
              <p className="text-slate-500 text-lg max-w-md mx-auto leading-relaxed">
                Get step-by-step answers tailored for Maharashtra SSC. With
                marking schemes, common traps, and examiner tips.
              </p>
            </div>
            <div className="grid grid-cols-2 gap-3">
              {QUICK_PROMPTS.map((prompt, i) => (
                ...
                >
                  ...
                  <div className="flex items-center gap-1 mt-2 text-[11px] font-medium text-indigo-500">
              ...
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  <h3 className="font-bold text-slate-800 mb-1">
                    Unlock Unlimited Doubts
                  </h3>
                  <p className="text-sm text-slate-500 mb-3">
                    Get examiner-style marking, image solving, and priority
                    support.
                  </p>
                  <button
          ...
          <div className="relative group">
            ...
            <div className="relative flex items-end gap-2 bg-white/90 backdrop-blur-xl rounded-2xl border border-white/60 shadow-[0_8px_32px_rgba(0,0,0,0.08)] p-3">
              <button
                ...
                className="flex-shrink-0 p-3 rounded-xl hover:bg-slate-100/80 transition-all duration-300 group/btn"
              >
                <ImagePlus
                  className={cn(
                    ...
                    selectedImage
                      ? 'text-indigo-500'
                      : 'text-slate-400 group-hover/btn:text-indigo-500',
                  )}
                />
              </button>
              <textarea
